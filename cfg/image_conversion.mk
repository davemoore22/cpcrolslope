...
PALETTE_PRESENTS=26 2 6 18 
$(eval $(call IMG2SP, SET_MODE,			1))
$(eval $(call IMG2SP, SET_PALETTE_FW,		$(PALETTE_PRESENTS)))
$(eval $(call IMG2SP, SET_OUTPUT,		bin))
$(eval $(call IMG2SP, SET_IMG_FORMAT,		screen))
$(eval $(call IMG2SP, SET_FOLDER,		tmp/))
#$(eval $(call IMG2SP, CONVERT,		img/title.png, 0, 0,title,,))
#$(eval $(call IMG2SP, CONVERT,		img/intro.png, 0, 0,intro,,))
#$(eval $(call IMG2SP, CONVERT,		img/made.png, 0, 0, made,,))
#$(eval $(call IMG2SP, CONVERT,		img/presents.png, 0, 0, presents,,))

PALETTE_IN=26 2 6 18 
$(eval $(call IMG2SP, SET_MODE,			1))
$(eval $(call IMG2SP, SET_PALETTE_FW,	$(PALETTE_IN)))
$(eval $(call IMG2SP, SET_IMG_FORMAT,	sprites))
$(eval $(call IMG2SP, SET_OUTPUT,		c))
#$(eval $(call IMG2SP, CONVERT         , img/in.png , 40, 24, array, palette, tileset))
#$(eval $(call IMG2SP, CONVERT         , img/128k.png , 76, 13, array, palette, tileset))
#$(eval $(call IMG2SP, CONVERT         , img/data.png , 100, 13, array, palette, tileset))

## Convert fonts to tileset
PALETTE_FONT={2 6 18 26}
#$(eval $(call IMG2SPRITES,img/font.png,1,font,12,13,$(PALETTE_FONT),tileset,out/))